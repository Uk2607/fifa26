    ...
    <div className="bg-gradient-to-r from-emerald-600/20 via-amber-600/15 to-emerald-600/20 border-b border-emerald-500/30 py-3 text-center">
      <div className="flex items-center justify-center gap-2 animate-pulse">
        ...
        <span className="text-amber-200 text-xs md:text-sm font-bold uppercase tracking-wider">
          Projected 2026 Champion: <span className="text-white bg-slate-950 px-3 py-1 rounded-lg border border-amber-500/40 ml-1.5 font-black"><img src={`https://flagcdn.com/w20/${TEAMS[tournamentChampion]?.iso2}.png`} alt="flag" className="inline-block w-4 h-[11px] object-cover rounded-[2px]" /> {TEAMS[tournamentChampion]?.name} ({tournamentChampion})</span>
        </span>
      </div>
    </div>
  );
