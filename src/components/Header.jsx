  ...
  return (
    <header className="relative z-[100] border-b border-theme-border bg-card-bg/50 backdrop-blur px-4 py-3.5 shadow-xl sticky top-0">
      <div className="max-w-[1920px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex flex-nowrap items-center justify-between w-full md:w-auto gap-2 mt-3 md:mt-0">
          {/* Team Search */}
          <TeamSearch onSelectTeam={onSelectTeam} />

          <div className="flex items-center gap-1.5 md:gap-2">
            {/* View Mode Toggle */}
            <div className="flex items-center bg-slate-800/80 rounded-lg p-0.5 border border-theme-border/60">
              <button
            ...
            <button
              onClick={onReset}
              className="bg-card-bg hover:bg-red-950/40 text-red-400 px-3 py-1.5 rounded-lg text-xs font-bold border border-red-900/20 transition active:scale-95 flex items-center gap-1.5 shrink-0"
            >
