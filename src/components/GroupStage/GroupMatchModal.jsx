                    ...
                    <tbody>
                      {groupStandings.map((team, index) => {
                        ...
                        return (
                          <tr
                            key={team.code}
                            className="border-b border-blue-800/30 last:border-0 hover:bg-blue-800/20 transition-all"
                          >
                            <td className="py-2.5 flex items-center gap-2 font-medium pl-3">
                              ...
                              <span className="text-blue-100 font-bold truncate max-w-[100px] text-[11px]">
                            ...
                            <td
                              className={`py-2.5 text-center font-black pr-2 ${highlightClass}`}
                            >
                              {team.pts}
                            </td>
                          </tr>
