...
export default function GroupWidget({
  ...
  return (
    <div
      style={{ fontSize: `calc(10px * var(--zoom-scale, 1))` }} className="rounded-[1.6em] transition-all duration-300 overflow-hidden p-[0.1em] bg-gradient-to-br from-theme-border/60 via-theme-border/20 to-theme-border/60 hover:from-emerald-500/50 hover:via-theme-border/50 hover:to-blue-500/50 cursor-pointer group shadow-lg"
      onClick={onToggle}
    >
